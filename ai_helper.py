...
これらの情報を参考にしながら、音声の内容を正確にテキストに変換してください。"""
    ...
    def generate_meeting_minutes_from_text(self, text: str) -> Tuple[bool, Dict[str, str]]:
        ...
        try:
            ...
            prompt = f"""この音声は、ある会議の音声です。この音声をもとに会議の要約を作成してください。
...
{{
    "議題・内容": "会議の概要（会議名、日時、参加者を含む）、何が議論されたのか、会議の結論、アクションアイテムを冒頭にまとめて記載してください。内容はMECEである必要があります。",
    "決定事項": "決定した事項があれば箇条書きで記述してください。なければ空文字列にしてください",
    "共有事項": "スタッフ間で共有すべき事項を箇条書きで記述してください。なければ空文字列にしてください",
    "その他メモ": "会議の流れをタイムスタンプごとの話題の概要を表形式で記載してください。以下の形式で記載してください。\\n\\n|タイムスタンプ|話題|備考|\\n|:---|:---|:---|\\n|00:00|話題1|備考1|\\n|00:05|話題2|備考2|\\n\\nもしも補足するべき内容があれば、備考に記載してください。表の中はすべて左詰となるようにします。なければ空文字列にしてください"
}}
